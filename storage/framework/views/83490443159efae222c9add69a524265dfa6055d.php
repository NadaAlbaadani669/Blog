...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.post-feautre-card','data' => ['post' => $posts[0]]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('post-feautre-card'); ?>
...
<?php endif; ?>
            <?php if($posts->count() > 1): ?>
                <div class="lg:grid lg:grid-cols-6">
                    ...
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.post-card','data' => ['post' => $post,'class' => ''.e($loop->iteration <3 ? 'col-span-3' : 'col-span-2').'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <?php endif; ?>
<?php /**PATH C:\Users\Nada Albaadani\Desktop\blog\resources\views/components/posts-grid.blade.php ENDPATH**/ ?>