            ...
            <form method="POST" action="" class="mt-10">
                ...
                <div class="mb-6">
                    <div class="mb-6">
                        ...
                        <input class="border border-gray-400 p-2 w-full" type="text" name="name" id="username" value="<?php echo e(old('name')); ?>" required><br>
...
<?php endif; ?>
<?php /**PATH C:\Users\Nada Albaadani\Desktop\blog\resources\views/register/create.blade.php ENDPATH**/ ?>